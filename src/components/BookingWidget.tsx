...
export default function BookingWidget() {
    return (
        <div className="glass p-8 rounded-3xl shadow-2xl border border-white/30 text-charcoal">
            <h3 className="text-xl font-serif mb-6 text-center">Inquire of Beauty</h3>

            <div className="space-y-4">
                <div className="relative">
                    <label className="text-[10px] uppercase tracking-widest text-charcoal/50 ml-1 mb-1 block">Service</label>
                    <div className="flex items-center bg-white/40 rounded-xl px-4 py-3 border border-white/20">
                        ...
                        <select className="bg-transparent w-full text-sm outline-none appearance-none cursor-pointer">
                            <option>Precision Hair Styling</option>
                            <option>Advanced Skincare</option>
                            <option>Artisanal Nails</option>
                        </select>
                    </div>
                </div>

                <div className="relative">
                    <label className="text-[10px] uppercase tracking-widest text-charcoal/50 ml-1 mb-1 block">Date</label>
                    <div className="flex items-center bg-white/40 rounded-xl px-4 py-3 border border-white/20">
                ...
                <div className="relative">
                    <label className="text-[10px] uppercase tracking-widest text-charcoal/50 ml-1 mb-1 block">Esthetician</label>
                    <div className="flex items-center bg-white/40 rounded-xl px-4 py-3 border border-white/20">
            ...
            <p className="text-[10px] text-center mt-6 text-charcoal/40 italic">
                * Tailored experiences await your presence
            </p>
        </div>
    );
}
